...
/**
 * @author CZL
 * @time 2016-05-23 8:37
 */
public class StoreTradeImage extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(StoreTradeImage.this, Commodity.class);
                startActivity(intent);
                StoreTradeImage.this.finish();
            }
        });
    ...
    public void chuan(View v) {
        RequestParams params = new RequestParams("http://119.29.148" +
                ".150:8080/Fuwu1/GetImage?pan=Trade&&number=" + bianh);
            ...
            public void onSuccess(String result) {
                ...
                if (!result.equals("0")) {
                    ...
                    new Timer().schedule(new TimerTask() {
                        @Override
                        public void run() {
                            Intent intent = new Intent(StoreTradeImage.this, Commodity
                                    .class);
                            StoreTradeImage.this.startActivity(intent);
                            //                            System.exit(0);
                            StoreTradeImage.this.finish();
                        }
                    }, 2000);
